...
// Only the nav globals are reset by seeding — they are the only ones with
// `navItems`, and settings globals like `merchant-center` hold operational
// configuration that demo content must never wipe.
